  ...
  return (function e(t, n, r) {
  ...
  })(
    {
      1: [
        function (require, module, exports) {
          (function (global) {
            ...
            function inspect(e) {
              if (functionsHaveNames || !util.isFunction(e))
            ...
            function getMessage(e) {
              return (
                truncate(inspect(e.actual), 128) +
                " " +
                e.operator +
                " " +
                truncate(inspect(e.expected), 128)
              );
            }
            ...
            function _deepEqual(e, t, r, n) {
              ...
              if (util.isDate(e) && util.isDate(t))
                return e.getTime() === t.getTime();
              if (util.isRegExp(e) && util.isRegExp(t))
                return (
                  e.source === t.source &&
                  e.global === t.global &&
              ...
              if (
                ...
                if (
                  isView(e) &&
                  isView(t) &&
                  pToString(e) === pToString(t) &&
                  !(e instanceof Float32Array || e instanceof Float64Array)
                )
                  return (
                    0 ===
                    compare(new Uint8Array(e.buffer), new Uint8Array(t.buffer))
                  );
                if (isBuffer(e) !== isBuffer(t)) return !1;
                var i = (n = n || { actual: [], expected: [] }).actual.indexOf(
                  e
                );
                return (
                  (-1 !== i && i === n.expected.indexOf(t)) ||
                  (n.actual.push(e), n.expected.push(t), objEquiv(e, t, r, n))
                );
              }
              return r ? e === t : e == t;
            }
            ...
            function notDeepStrictEqual(e, t, r) {
              _deepEqual(e, t, !0) &&
                fail(e, t, r, "notDeepStrictEqual", notDeepStrictEqual);
            }
            ...
            function _throws(e, t, r, n) {
              ...
              "string" == typeof r && ((n = r), (r = null)),
                ...
                (n =
                  (r && r.name ? " (" + r.name + ")." : ".") +
                  (n ? " " + n : ".")),
                e && !i && fail(i, r, "Missing expected exception" + n);
              var a = "string" == typeof n,
                s = !e && util.isError(i),
                o = !e && i && !r;
              if (
                (((s && a && expectedException(i, r)) || o) &&
                  fail(i, r, "Got unwanted exception" + n),
                (e && i && r && !expectedException(i, r)) || (!e && i))
              )
                throw i;
            }
            ...
            (assert.AssertionError = function (e) {
              ...
              (assert.deepEqual = function (e, t, r) {
                _deepEqual(e, t, !1) ||
                  fail(e, t, r, "deepEqual", assert.deepEqual);
              }),
              (assert.deepStrictEqual = function (e, t, r) {
                _deepEqual(e, t, !0) ||
                  fail(e, t, r, "deepStrictEqual", assert.deepStrictEqual);
              }),
              (assert.notDeepEqual = function (e, t, r) {
                _deepEqual(e, t, !1) &&
                  fail(e, t, r, "notDeepEqual", assert.notDeepEqual);
              }),
              (assert.notDeepStrictEqual = notDeepStrictEqual),
              (assert.strictEqual = function (e, t, r) {
      ...
      2: [
        function (require, module, exports) {
          ...
          function toByteArray(o) {
            ...
            for (r = 0; r < e; r += 4)
              (t =
                (revLookup[o.charCodeAt(r)] << 18) |
                (revLookup[o.charCodeAt(r + 1)] << 12) |
                (revLookup[o.charCodeAt(r + 2)] << 6) |
                revLookup[o.charCodeAt(r + 3)]),
                (n[a++] = (t >> 16) & 255),
                (n[a++] = (t >> 8) & 255),
                (n[a++] = 255 & t);
            return (
              2 === u
                ? ((t =
                    (revLookup[o.charCodeAt(r)] << 2) |
                    (revLookup[o.charCodeAt(r + 1)] >> 4)),
                  (n[a++] = 255 & t))
                : 1 === u &&
                  ((t =
                    (revLookup[o.charCodeAt(r)] << 10) |
                    (revLookup[o.charCodeAt(r + 1)] << 4) |
                    (revLookup[o.charCodeAt(r + 2)] >> 2)),
                  (n[a++] = (t >> 8) & 255),
                  (n[a++] = 255 & t)),
              n
            );
          ...
          function fromByteArray(o) {
            for (
              var r, e = o.length, t = e % 3, u = "", n = [], p = 0, a = e - t;
              p < a;
              p += 16383
            )
          ...
          !(function (t, i) {
            ...
            (n.isBN = function (t) {
              ...
              (n.prototype._parseHex = function (t, i) {
                ...
                var h,
                  n,
                  o = 0;
                for (r = t.length - 6, h = 0; r >= i; r -= 6)
                  (n = e(t, r, r + 6)),
                    (this.words[h] |= (n << o) & 67108863),
                    (this.words[h + 1] |= (n >>> (26 - o)) & 4194303),
                    (o += 24) >= 26 && ((o -= 26), h++);
                r + 6 !== i &&
                  ((n = e(t, i, r + 6)),
                  (this.words[h] |= (n << o) & 67108863),
            ...
            (n.prototype.toString = function (t, i) {
              ...
              if (16 === t || "hex" === t) {
                ...
                for (0 !== e && (h = e.toString(16) + h); h.length % i != 0; )
                  h = "0" + h;
              ...
              if (t === (0 | t) && t >= 2 && t <= 36) {
                ...
                for (m.negative = 0; !m.isZero(); ) {
                  ...
                  h = (m = m.idivn(l)).isZero()
                    ? f + h
                    : y[a - f.length] + f + h;
                }
                for (this.isZero() && (h = "0" + h); h.length % i != 0; )
                  h = "0" + h;
                return 0 !== this.negative && (h = "-" + h), h;
              }
              ...
              (n.prototype.inotn = function (t) {
                ...
                return (
                  h > 0 &&
                    (this.words[n] = ~this.words[n] & (67108863 >> (26 - h))),
                  this.strip()
                );
              }),
              ...
              (n.prototype.isub = function (t) {
                ...
                for (var e = 0, o = 0; o < n.length; o++)
                  (e = (i = (0 | h.words[o]) - (0 | n.words[o]) + e) >> 26),
                    (this.words[o] = 67108863 & i);
                for (; 0 !== e && o < h.length; o++)
                  (e = (i = (0 | h.words[o]) + e) >> 26),
                    (this.words[o] = 67108863 & i);
            ...
            var k = function (t, i, r) {
              ...
              var vt =
                (((a + (h = Math.imul(m, F))) | 0) +
                  ((8191 &
                    (n = ((n = Math.imul(m, C)) + Math.imul(f, F)) | 0)) <<
                    13)) |
                0;
              (a =
                ((((e = Math.imul(f, C)) + (n >>> 13)) | 0) + (vt >>> 26)) | 0),
                (vt &= 67108863),
                (h = Math.imul(p, F)),
                (n = ((n = Math.imul(p, C)) + Math.imul(M, F)) | 0),
                (e = Math.imul(M, C));
              var gt =
                (((a + (h = (h + Math.imul(m, H)) | 0)) | 0) +
                  ((8191 &
                    (n =
                      ((n = (n + Math.imul(m, J)) | 0) + Math.imul(f, H)) |
                      0)) <<
                    13)) |
                0;
              (a =
                ((((e = (e + Math.imul(f, J)) | 0) + (n >>> 13)) | 0) +
                  (gt >>> 26)) |
                0),
                (gt &= 67108863),
                (h = Math.imul(g, F)),
              ...
              var ct =
                (((a + (h = (h + Math.imul(m, G)) | 0)) | 0) +
                  ((8191 &
                    (n =
                      ((n = (n + Math.imul(m, Q)) | 0) + Math.imul(f, G)) |
                      0)) <<
                    13)) |
                0;
              (a =
              ...
              var wt =
                (((a + (h = (h + Math.imul(m, W)) | 0)) | 0) +
                  ((8191 &
                    (n =
                      ((n = (n + Math.imul(m, X)) | 0) + Math.imul(f, W)) |
                      0)) <<
                    13)) |
                0;
              (a =
              ...
              var yt =
                (((a + (h = (h + Math.imul(m, $)) | 0)) | 0) +
                  ((8191 &
                    (n =
                      ((n = (n + Math.imul(m, tt)) | 0) + Math.imul(f, $)) |
                      0)) <<
                    13)) |
                0;
              (a =
                ...
                (yt &= 67108863),
                (h = Math.imul(S, F)),
                (n = ((n = Math.imul(S, C)) + Math.imul(Z, F)) | 0),
                (e = Math.imul(Z, C)),
                (h = (h + Math.imul(k, H)) | 0),
              ...
              var bt =
                (((a + (h = (h + Math.imul(m, rt)) | 0)) | 0) +
                  ((8191 &
                    (n =
                      ((n = (n + Math.imul(m, ht)) | 0) + Math.imul(f, rt)) |
                      0)) <<
                    13)) |
                0;
              (a =
                ((((e = (e + Math.imul(f, ht)) | 0) + (n >>> 13)) | 0) +
                  (bt >>> 26)) |
                0),
                (bt &= 67108863),
                (h = Math.imul(R, F)),
                ...
                (e = Math.imul(B, C)),
                (h = (h + Math.imul(S, H)) | 0),
                (n = ((n = (n + Math.imul(S, J)) | 0) + Math.imul(Z, H)) | 0),
                (e = (e + Math.imul(Z, J)) | 0),
                (h = (h + Math.imul(k, G)) | 0),
              ...
              var _t =
                (((a + (h = (h + Math.imul(m, et)) | 0)) | 0) +
                  ((8191 &
                    (n =
                      ((n = (n + Math.imul(m, ot)) | 0) + Math.imul(f, et)) |
                      0)) <<
                    13)) |
                0;
              (a =
                ((((e = (e + Math.imul(f, ot)) | 0) + (n >>> 13)) | 0) +
                  (_t >>> 26)) |
                0),
                (_t &= 67108863),
                (h = Math.imul(L, F)),
                ...
                (e = (e + Math.imul(B, J)) | 0),
                (h = (h + Math.imul(S, G)) | 0),
                (n = ((n = (n + Math.imul(S, Q)) | 0) + Math.imul(Z, G)) | 0),
                (e = (e + Math.imul(Z, Q)) | 0),
                (h = (h + Math.imul(k, W)) | 0),
              ...
              var kt =
                (((a + (h = (h + Math.imul(m, ut)) | 0)) | 0) +
                  ((8191 &
                    (n =
                      ((n = (n + Math.imul(m, at)) | 0) + Math.imul(f, ut)) |
                      0)) <<
                    13)) |
                0;
              (a =
                ((((e = (e + Math.imul(f, at)) | 0) + (n >>> 13)) | 0) +
                  (kt >>> 26)) |
                0),
                (kt &= 67108863),
                (h = Math.imul(T, F)),
                ...
                (e = (e + Math.imul(B, Q)) | 0),
                (h = (h + Math.imul(S, W)) | 0),
                (n = ((n = (n + Math.imul(S, X)) | 0) + Math.imul(Z, W)) | 0),
                (e = (e + Math.imul(Z, X)) | 0),
                (h = (h + Math.imul(k, $)) | 0),
              ...
              var At =
                (((a + (h = (h + Math.imul(m, mt)) | 0)) | 0) +
                  ((8191 &
                    (n =
                      ((n = (n + Math.imul(m, ft)) | 0) + Math.imul(f, mt)) |
                      0)) <<
                    13)) |
                0;
              (a =
                ((((e = (e + Math.imul(f, ft)) | 0) + (n >>> 13)) | 0) +
                  (At >>> 26)) |
                0),
                (At &= 67108863),
                (h = Math.imul(j, F)),
                ...
                (e = (e + Math.imul(B, X)) | 0),
                (h = (h + Math.imul(S, $)) | 0),
                (n = ((n = (n + Math.imul(S, tt)) | 0) + Math.imul(Z, $)) | 0),
              ...
              var xt =
                (((a + (h = (h + Math.imul(m, pt)) | 0)) | 0) +
                  ((8191 &
                    (n =
                      ((n = (n + Math.imul(m, Mt)) | 0) + Math.imul(f, pt)) |
                      0)) <<
                    13)) |
                0;
              (a =
                ((((e = (e + Math.imul(f, Mt)) | 0) + (n >>> 13)) | 0) +
                  (xt >>> 26)) |
                0),
                (xt &= 67108863),
                (h = Math.imul(j, H)),
                ...
                (n = ((n = (n + Math.imul(S, ht)) | 0) + Math.imul(Z, rt)) | 0),
              ...
              (a =
                ...
                (n = ((n = (n + Math.imul(S, ot)) | 0) + Math.imul(Z, et)) | 0),
              ...
              var Zt =
                (((a + (h = (h + Math.imul(g, pt)) | 0)) | 0) +
                  ((8191 &
                    (n =
                      ((n = (n + Math.imul(g, Mt)) | 0) + Math.imul(c, pt)) |
                      0)) <<
                    13)) |
                0;
              (a =
                ((((e = (e + Math.imul(c, Mt)) | 0) + (n >>> 13)) | 0) +
                  (Zt >>> 26)) |
                0),
                (Zt &= 67108863),
                (h = Math.imul(j, W)),
                ...
                (n = ((n = (n + Math.imul(S, at)) | 0) + Math.imul(Z, ut)) | 0),
                (e = (e + Math.imul(Z, at)) | 0),
                (h = (h + Math.imul(k, mt)) | 0),
                (n = ((n = (n + Math.imul(k, ft)) | 0) + Math.imul(A, mt)) | 0),
                (e = (e + Math.imul(A, ft)) | 0);
              var qt =
                (((a + (h = (h + Math.imul(y, pt)) | 0)) | 0) +
                  ((8191 &
                    (n =
                      ((n = (n + Math.imul(y, Mt)) | 0) + Math.imul(b, pt)) |
                      0)) <<
                    13)) |
                0;
              (a =
                ((((e = (e + Math.imul(b, Mt)) | 0) + (n >>> 13)) | 0) +
                  (qt >>> 26)) |
                0),
                (qt &= 67108863),
                (h = Math.imul(j, $)),
                ...
                (n = ((n = (n + Math.imul(S, ft)) | 0) + Math.imul(Z, mt)) | 0),
                (e = (e + Math.imul(Z, ft)) | 0);
              var Rt =
                (((a + (h = (h + Math.imul(k, pt)) | 0)) | 0) +
                  ((8191 &
                    (n =
                      ((n = (n + Math.imul(k, Mt)) | 0) + Math.imul(A, pt)) |
                      0)) <<
                    13)) |
                0;
              (a =
                ((((e = (e + Math.imul(A, Mt)) | 0) + (n >>> 13)) | 0) +
                  (Rt >>> 26)) |
                0),
                (Rt &= 67108863),
                (h = Math.imul(j, rt)),
                ...
                (e = (e + Math.imul(B, ft)) | 0);
              var Bt =
                (((a + (h = (h + Math.imul(S, pt)) | 0)) | 0) +
                  ((8191 &
                    (n =
                      ((n = (n + Math.imul(S, Mt)) | 0) + Math.imul(Z, pt)) |
                      0)) <<
                    13)) |
                0;
              (a =
                ((((e = (e + Math.imul(Z, Mt)) | 0) + (n >>> 13)) | 0) +
                  (Bt >>> 26)) |
                0),
                (Bt &= 67108863),
                (h = Math.imul(j, et)),
              ...
              var Nt =
                (((a + (h = (h + Math.imul(R, pt)) | 0)) | 0) +
                  ((8191 &
                    (n =
                      ((n = (n + Math.imul(R, Mt)) | 0) + Math.imul(B, pt)) |
                      0)) <<
                    13)) |
                0;
              (a =
              ...
              var Lt =
                (((a + (h = (h + Math.imul(L, pt)) | 0)) | 0) +
                  ((8191 &
                    (n =
                      ((n = (n + Math.imul(L, Mt)) | 0) + Math.imul(I, pt)) |
                      0)) <<
                    13)) |
                0;
              (a =
                ((((e = (e + Math.imul(I, Mt)) | 0) + (n >>> 13)) | 0) +
                  (Lt >>> 26)) |
                0),
                (Lt &= 67108863),
                (h = Math.imul(j, mt)),
                ...
                (e = Math.imul(K, ft));
              var It =
                (((a + (h = (h + Math.imul(T, pt)) | 0)) | 0) +
                  ((8191 &
                    (n =
                      ((n = (n + Math.imul(T, Mt)) | 0) + Math.imul(E, pt)) |
                      0)) <<
                    13)) |
                0;
              (a =
                ((((e = (e + Math.imul(E, Mt)) | 0) + (n >>> 13)) | 0) +
                  (It >>> 26)) |
                0),
                (It &= 67108863);
              var zt =
                (((a + (h = Math.imul(j, pt))) | 0) +
                  ((8191 &
                    (n = ((n = Math.imul(j, Mt)) + Math.imul(K, pt)) | 0)) <<
                    13)) |
                0;
              return (
                (a =
                  ((((e = Math.imul(K, Mt)) + (n >>> 13)) | 0) + (zt >>> 26)) |
                  0),
                (zt &= 67108863),
                (u[0] = vt),
                (u[1] = gt),
            ...
            Math.imul || (k = u),
              ...
              (n.prototype.mulf = function (t) {
                var i = new n(null);
                return (
                  (i.words = new Array(this.length + t.length)), l(this, t, i)
                );
              }),
              ...
              (n.prototype.pow = function (t) {
                ...
                if (++h < i.length)
                  for (var e = r.sqr(); h < i.length; h++, e = e.sqr())
                    0 !== i[h] && (r = r.mul(e));
                return r;
              }),
              ...
              (n.prototype.imaskn = function (t) {
                ...
                if (
                  (0 !== i && h++,
                  (this.length = Math.min(h, this.length)),
                  0 !== i)
                ) {
              ...
              (n.prototype._ishlnsubmul = function (t, i, h) {
                ...
                for (n = 0; n < t.length; n++) {
                  ...
                  (s = ((o -= 67108863 & u) >> 26) - ((u / 67108864) | 0)),
                    (this.words[n + h] = 67108863 & o);
                }
                for (; n < this.length - h; n++)
                  (s = (o = (0 | this.words[n + h]) + s) >> 26),
                    (this.words[n + h] = 67108863 & o);
              ...
              (n.prototype._wordDiv = function (t, i) {
                ...
                for (var m = u - 1; m >= 0; m--) {
                  var f =
                    67108864 * (0 | h.words[e.length + m]) +
                    (0 | h.words[e.length + m - 1]);
                  for (
                    f = Math.min((f / o) | 0, 67108863),
                      h._ishlnsubmul(e, f, m);
                    0 !== h.negative;
              ...
              (n.prototype.divmod = function (t, i, h) {
                ...
                return 0 !== this.negative && 0 === t.negative
                  ? ((s = this.neg().divmod(t, i)),
                    "mod" !== i && (e = s.div.neg()),
                    "div" !== i &&
                      ((o = s.mod.neg()), h && 0 !== o.negative && o.iadd(t)),
                    { div: e, mod: o })
                  ...
                  ? ((s = this.neg().divmod(t.neg(), i)),
                    "div" !== i &&
                      ((o = s.mod.neg()), h && 0 !== o.negative && o.isub(t)),
                    { div: s.div, mod: o })
              ...
              (n.prototype.modn = function (t) {
                r(t <= 67108863);
                for (
                  var i = (1 << 26) % t, h = 0, n = this.length - 1;
                  n >= 0;
                  n--
                )
                  h = (i * h + (0 | this.words[n])) % t;
                return h;
              }),
              ...
              (n.prototype.egcd = function (t) {
                ...
                for (var l = h.clone(), m = i.clone(); !i.isZero(); ) {
                  ...
                  if (f > 0)
                    for (i.iushrn(f); f-- > 0; )
                      (e.isOdd() || o.isOdd()) && (e.iadd(l), o.isub(m)),
                        e.iushrn(1),
                        o.iushrn(1);
                  for (
                    var p = 0, M = 1;
                  ...
                  if (p > 0)
                    for (h.iushrn(p); p-- > 0; )
                      (s.isOdd() || u.isOdd()) && (s.iadd(l), u.isub(m)),
                        ...
                        u.iushrn(1);
                  i.cmp(h) >= 0
                    ? (i.isub(h), e.isub(s), o.isub(u))
                    : (h.isub(i), s.isub(e), u.isub(o));
                }
                return { a: s, b: u, gcd: h.iushln(a) };
              }),
              (n.prototype._invmp = function (t) {
                ...
                i = 0 !== i.negative ? i.umod(t) : i.clone();
                for (
                  var e = new n(1), o = new n(0), s = h.clone();
                  i.cmpn(1) > 0 && h.cmpn(1) > 0;
                ...
                var f;
                return (
                  (f = 0 === i.cmpn(1) ? e : o).cmpn(0) < 0 && f.iadd(t), f
                );
              }),
              ...
              (n.prototype.bincn = function (t) {
                ...
                var i = t % 26,
                  ...
                  n = 1 << i;
                if (this.length <= h)
                  return this._expand(h + 1), (this.words[h] |= n), this;
            ...
            (f.prototype._tmp = function () {
              ...
              h(d, f),
              (d.prototype.split = function (t, i) {
                ...
                var n = t.words[9];
                for (
                  i.words[i.length++] = 4194303 & n, h = 10;
                  h < t.length;
                  h++
                ) {
                  var e = 0 | t.words[h];
      ...
      5: [
        function (require, module, exports) {
          ...
          if (
            ...
            (Rand.prototype.generate = function (t) {
              return this._rand(t);
            }),
            (Rand.prototype._rand = function (t) {
              if (this.rand.getBytes) return this.rand.getBytes(t);
              for (var r = new Uint8Array(t), e = 0; e < r.length; e++)
                r[e] = this.rand.getByte();
              return r;
            }),
            "object" == typeof self)
          )
      ...
      7: [
        function (require, module, exports) {
          (function (Buffer) {
            ...
            var hash = function (t) {
              if (void 0 !== t && -1 == hashLengths.indexOf(t))
                throw new Error("Unsupported hash length");
              (this.content = []),
                (this.bitcount = t ? "keccak_" + t : "keccak_512");
            };
            (hash.prototype.update = function (t) {
              ...
              (hash.prototype.digest = function (t) {
                ...
                if ("hex" === t) return e;
                if ("binary" === t || void 0 === t)
                  return new Buffer(e, "hex").toString("binary");
      ...
      8: [
        function (require, module, exports) {
          ...
          function from(e, t, r) {
            ...
            return isArrayBuffer(e)
              ? fromArrayBuffer(e, t, r)
              : "string" == typeof e
              ? fromString(e, t)
              : fromObject(e);
          }
          ...
          function fromObject(e) {
            ...
            if (e) {
              if (isArrayBufferView(e) || "length" in e)
          ...
          function bidirectionalIndexOf(e, t, r, n, f) {
            ...
            if (
              ...
              (r = +r),
              numberIsNaN(r) && (r = f ? 0 : e.length - 1),
              r < 0 && (r = e.length + r),
              r >= e.length)
            ) {
              if (f) return -1;
          ...
          function base64Slice(e, t, r) {
            return 0 === t && r === e.length
              ? base64.fromByteArray(e)
              : base64.fromByteArray(e.slice(t, r));
          }
          ...
          function base64clean(e) {
            if ((e = e.trim().replace(INVALID_BASE64_RE, "")).length < 2)
              return "";
            for (; e.length % 4 != 0; ) e += "=";
            return e;
          }
          ...
          (Buffer.prototype.slice = function (e, t) {
            ...
            (Buffer.prototype.copy = function (e, t, r, n) {
              ...
              else if (i < 1e3) for (f = 0; f < i; ++f) e[f + t] = this[f + r];
      ...
      9: [
        function (require, module, exports) {
          ...
          inherits(CipherBase, Transform),
            ...
            (CipherBase.prototype._toString = function (t, e, r) {
              if (
                (this._decoder ||
                  ((this._decoder = new StringDecoder(e)),
                  (this._encoding = e)),
                this._encoding !== e)
              )
        ...
        { inherits: 51, "safe-buffer": 82, stream: 97, string_decoder: 98 },
      ],
      10: [
        function (require, module, exports) {
          (function (Buffer) {
            ...
            function isError(r) {
              return (
                "[object Error]" === objectToString(r) || r instanceof Error
              );
            }
        ...
        function (require, module, exports) {
          (function (Buffer) {
            ...
            inherits(HashNoConstructor, Base),
              (HashNoConstructor.prototype._update = function (s) {
                this.buffers.push(s);
              }),
              ...
              inherits(Hash, Base),
              (Hash.prototype._update = function (s) {
                this._hash.update(s);
              }),
              ...
              (module.exports = function (s) {
                return "md5" === (s = s.toLowerCase())
                  ? new HashNoConstructor(md5)
                  : new Hash(
                      "rmd160" === s || "ripemd160" === s
                        ? new RIPEMD160()
                        : sha(s)
                    );
              });
        ...
        function (require, module, exports) {
          (function (Buffer) {
            ...
            function toArray(e) {
              ...
              for (
                var t = new Array(e.length >>> 2), n = 0, i = 0;
                n < e.length;
                n += intSize, i++
              )
                t[i] = e.readInt32LE(n);
      ...
      13: [
        function (require, module, exports) {
              ...
              (f = md5_ii(
                (f = md5_ii(
                  (f = md5_ii(
                    (f = md5_ii(
                      (f = md5_hh(
                        (f = md5_hh(
                          ...
                          (i = md5_hh(
                            ...
                            (h = md5_hh(
                              h,
                              (m = md5_hh(m, f, i, h, d[g + 13], 4, 681279174)),
                              f,
                              i,
                              d[g + 0],
                              11,
                        ...
                        (i = md5_hh(
                          ...
                          (h = md5_hh(
                            h,
                            (m = md5_hh(m, f, i, h, d[g + 9], 4, -640364487)),
                            f,
                            i,
                            d[g + 12],
                            11,
                      ...
                      (i = md5_ii(
                        ...
                        (h = md5_ii(
                          h,
                          (m = md5_ii(m, f, i, h, d[g + 0], 6, -198630844)),
                          f,
                          i,
                          d[g + 7],
                          10,
                    ...
                    (i = md5_ii(
                      ...
                      (h = md5_ii(
                        h,
                        (m = md5_ii(m, f, i, h, d[g + 12], 6, 1700485571)),
                        f,
                        i,
                        d[g + 3],
                        10,
                  ...
                  (i = md5_ii(
                    ...
                    (h = md5_ii(
                      h,
                      (m = md5_ii(m, f, i, h, d[g + 8], 6, 1873313359)),
                      f,
                      i,
                      d[g + 15],
                      10,
                ...
                (i = md5_ii(
                  ...
                  (h = md5_ii(
                    h,
                    (m = md5_ii(m, f, i, h, d[g + 4], 6, -145523070)),
                    f,
                    i,
                    d[g + 11],
                    10,
          ...
          function md5_cmn(d, _, m, f, i, h) {
            return safe_add(
              bit_rol(safe_add(safe_add(_, d), safe_add(f, h)), i),
              m
            );
          }
          ...
          (module.exports = BaseCurve),
            ...
            (BaseCurve.prototype._fixedNafMul = function (t, e) {
              ...
              for (var o = [], s = 0; s < r.length; s += n.step) {
                for (var a = 0, e = s + n.step - 1; e >= s; e--)
                  a = (a << 1) + r[e];
                o.push(a);
              }
              for (
                ...
                for (s = 0; s < o.length; s++)
                  (a = o[s]) === d
                    ? (u = u.mixedAdd(n.points[s]))
                    : a === -d && (u = u.mixedAdd(n.points[s].neg()));
                p = p.add(u);
              }
              return p.toP();
            }),
            ...
            (BaseCurve.prototype._wnafMulAdd = function (t, e, n, r, i) {
              ...
              for (u = r - 1; u >= 1; u -= 2) {
                ...
                if (1 === o[l] && 1 === o[h]) {
                  ...
                  0 === e[l].y.cmp(e[h].y)
                    ? ((f[1] = e[l].add(e[h])),
                      (f[2] = e[l].toJ().mixedAdd(e[h].neg())))
                    : 0 === e[l].y.cmp(e[h].y.redNeg())
                    ? ((f[1] = e[l].toJ().mixedAdd(e[h])),
                      (f[2] = e[l].add(e[h].neg())))
                    : ((f[1] = e[l].toJ().mixedAdd(e[h])),
                      (f[2] = e[l].toJ().mixedAdd(e[h].neg())));
                  var c = [-3, -1, -5, -7, 0, 7, 5, 1, 3],
                    g = getJSF(n[l], n[h]);
                  (p = Math.max(g[0].length, p)),
                    (a[l] = new Array(p)),
                    (a[h] = new Array(p));
                  for (b = 0; b < p; b++) {
                    var v = 0 | g[0][b],
                  ...
                  (a[l] = getNAF(n[l], o[l])),
                    (a[h] = getNAF(n[h], o[h])),
                    (p = Math.max(a[l].length, p)),
                    (p = Math.max(a[h].length, p));
              }
              for (
                var y = this.jpoint(null, null, null), w = this._wnafT4, u = p;
                u >= 0;
                u--
              ) {
                for (var B = 0; u >= 0; ) {
                  for (var A = !0, b = 0; b < r; b++)
                    (w[b] = 0 | a[b][u]), 0 !== w[b] && (A = !1);
                  if (!A) break;
                  B++, u--;
                }
                ...
                for (b = 0; b < r; b++) {
                  ...
                  0 !== _ &&
                    (_ > 0
                      ? (N = s[b][(_ - 1) >> 1])
                      : _ < 0 && (N = s[b][(-_ - 1) >> 1].neg()),
                    (y = "affine" === N.type ? y.mixedAdd(N) : y.add(N)));
                }
              }
            ...
            (BaseCurve.prototype.decodePoint = function (t, e) {
              ...
              if (
                ...
                return (
                  6 === t[0]
                    ? assert(t[t.length - 1] % 2 == 0)
                    : 7 === t[0] && assert(t[t.length - 1] % 2 == 1),
      ...
      16: [
        function (require, module, exports) {
          ...
          function EdwardsCurve(t) {
            (this.twisted = 1 != (0 | t.a)),
              ...
              Base.call(this, "edwards", t),
              (this.a = new BN(t.a, 16).umod(this.red.m)),
              (this.a = this.a.toRed(this.red)),
              (this.c = new BN(t.c, 16).toRed(this.red)),
              (this.c2 = this.c.redSqr()),
              (this.d = new BN(t.d, 16).toRed(this.red)),
              (this.dd = this.d.redAdd(this.d)),
              assert(!this.twisted || 0 === this.c.fromRed().cmpn(1)),
              (this.oneC = 1 == (0 | t.c));
          }
          function Point(t, r, e, i, d) {
            Base.BasePoint.call(this, t, "projective"),
              null === r && null === e && null === i
                ...
                : ((this.x = new BN(r, 16)),
                  (this.y = new BN(e, 16)),
                  (this.z = i ? new BN(i, 16) : this.curve.one),
                  (this.t = d && new BN(d, 16)),
          ...
          inherits(EdwardsCurve, Base),
            ...
            (EdwardsCurve.prototype.pointFromX = function (t, r) {
              ...
              var e = t.redSqr(),
                ...
                u = s.redSqrt();
              if (0 !== u.redSqr().redSub(s).cmp(this.zero))
                throw new Error("invalid point");
              var n = u.fromRed().isOdd();
              return (
                ((r && !n) || (!r && n)) && (u = u.redNeg()), this.point(t, u)
              );
            }),
            ...
            (Point.prototype._projDbl = function () {
              ...
              if (this.curve.twisted) {
                ...
                if (this.zOne)
                  (t = i.redSub(d).redSub(s).redMul(u.redSub(this.curve.two))),
                    (r = u.redMul(o.redSub(s))),
                    (e = u.redSqr().redSub(u).redSub(u));
                else {
                  var n = this.z.redSqr(),
                    h = u.redSub(n).redISub(n);
                  (t = i.redSub(d).redISub(s).redMul(h)),
                    (r = u.redMul(o.redSub(s))),
                    (e = u.redMul(h));
                }
              } else {
                ...
                (t = this.curve._mulC(i.redISub(o)).redMul(h)),
                  (r = this.curve._mulC(o).redMul(d.redISub(s))),
                  (e = o.redMul(h));
              }
            ...
            (Point.prototype._projAdd = function (t) {
              ...
              return (
                this.curve.twisted
                  ? ((r = i.redMul(o).redMul(u.redSub(this.curve._mulA(s)))),
                    (e = h.redMul(o)))
                  : ((r = i.redMul(o).redMul(u.redSub(s))),
                    (e = this.curve._mulC(h).redMul(o))),
                this.curve.point(c, r, e)
              );
            }),
        ...
        { "../../elliptic": 14, "../curve": 17, "bn.js": 4, inherits: 51 },
      ],
      17: [
        function (require, module, exports) {
          "use strict";
        ...
        { "./base": 15, "./edwards": 16, "./mont": 18, "./short": 19 },
      ],
      18: [
        function (require, module, exports) {
          "use strict";
          function MontCurve(t) {
            Base.call(this, "mont", t),
          ...
          inherits(MontCurve, Base),
            ...
            inherits(Point, Base.BasePoint),
            (MontCurve.prototype.decodePoint = function (t, r) {
            ...
            (Point.prototype.mul = function (t) {
              ...
              for (var u = n.length - 1; u >= 0; u--)
                0 === n[u]
                  ? ((e = e.diffAdd(i, o)), (i = i.dbl()))
                  : ((i = e.diffAdd(i, o)), (e = e.dbl()));
              return i;
            }),
      ...
      19: [
        function (require, module, exports) {
          ...
          function ShortCurve(r) {
            Base.call(this, "short", r),
              (this.a = new BN(r.a, 16).toRed(this.red)),
              (this.b = new BN(r.b, 16).toRed(this.red)),
          ...
          function JPoint(r, e, t, d) {
            Base.BasePoint.call(this, r, "jacobian"),
              null === e && null === t && null === d
          ...
          inherits(ShortCurve, Base),
            ...
            (ShortCurve.prototype._getEndomorphism = function (r) {
              if (this.zeroA && this.g && this.n && 1 === this.p.modn(3)) {
                ...
                if (r.lambda) t = new BN(r.lambda, 16);
                  ...
                  0 === this.g.mul(i[0]).x.cmp(this.g.x.redMul(e))
                    ? (t = i[0])
                    : ((t = i[1]),
                      assert(0 === this.g.mul(t).x.cmp(this.g.x.redMul(e))));
                }
                var n;
                return (
                  (n = r.basis
            ...
            (ShortCurve.prototype._getEndoBasis = function (r) {
              ...
              return (
                n.sqr().add(u.sqr()).cmp(A) >= 0 && ((n = e), (u = t)),
                d.negative && ((d = d.neg()), (i = i.neg())),
                n.negative && ((n = n.neg()), (u = u.neg())),
                [
                  { a: d, b: i },
                  { a: n, b: u },
                ]
            ...
            (ShortCurve.prototype.pointFromX = function (r, e) {
              ...
              var t = r
                  .redSqr()
                  .redMul(r)
                  .redIAdd(r.redMul(this.a))
                  .redIAdd(this.b),
                d = t.redSqrt();
              if (0 !== d.redSqr().redSub(t).cmp(this.zero))
                throw new Error("invalid point");
              var i = d.fromRed().isOdd();
              return (
                ((e && !i) || (!e && i)) && (d = d.redNeg()), this.point(r, d)
              );
            }),
            ...
            (ShortCurve.prototype._endoWnafMulAdd = function (r, e, t) {
              for (
                var d = this._endoWnafT1, i = this._endoWnafT2, n = 0;
                n < r.length;
                n++
              ) {
              ...
              for (
                var h = this._wnafMulAdd(1, d, i, 2 * n, t), l = 0;
                l < 2 * n;
                l++
              )
                (d[l] = null), (i[l] = null);
            ...
            (Point.prototype.eq = function (r) {
              return (
                ...
                (this.inf === r.inf &&
                  (this.inf ||
                    (0 === this.x.cmp(r.x) && 0 === this.y.cmp(r.y))))
              );
            }),
            ...
            (JPoint.prototype._zeroDbl = function () {
              ...
              if (this.zOne) {
                ...
                (S = (S = S.redIAdd(S)).redIAdd(S)),
                  (r = v.redISub(c).redISub(c)),
                  (e = f.redMul(c.redISub(r)).redISub(S)),
            ...
            (JPoint.prototype._threeDbl = function () {
              ...
              if (this.zOne) {
                ...
                (r = c.redSqr().redISub(v)),
                  (t = this.y.redAdd(this.z).redSqr().redISub(p).redISub(l));
                var S = p.redSqr();
                (S = (S = (S = S.redIAdd(S)).redIAdd(S)).redIAdd(S)),
                  (e = c.redMul(f.redISub(r)).redISub(S));
              }
              return this.curve.jpoint(r, e, t);
            }),
            ...
            (JPoint.prototype.trpl = function () {
              ...
              var r = this.x.redSqr(),
                ...
                s = (u = (u = (u = u.redIAdd(u)).redAdd(u).redIAdd(u)).redISub(
                  n
                )).redSqr(),
                o = d.redIAdd(d);
              ...
              var a = this.y.redMul(
                h.redMul(o.redISub(h)).redISub(u.redMul(s))
              );
              a = (a = (a = a.redIAdd(a)).redIAdd(a)).redIAdd(a);
            ...
            (JPoint.prototype.eq = function (r) {
              ...
              var e = this.z.redSqr(),
                t = r.z.redSqr();
              if (0 !== this.x.redMul(t).redISub(r.x.redMul(e)).cmpn(0))
                return !1;
      ...
      20: [
        function (require, module, exports) {
          ...
          function PresetCurve(f) {
            "short" === f.type
              ? (this.curve = new elliptic.curve.short(f))
              : "edwards" === f.type
              ? (this.curve = new elliptic.curve.edwards(f))
              : (this.curve = new elliptic.curve.mont(f)),
              (this.g = this.curve.g),
              (this.n = this.curve.n),
              (this.hash = f.hash),
        ...
        { "../elliptic": 14, "./precomputed/secp256k1": 27, "hash.js": 37 },
      ],
      21: [
        function (require, module, exports) {
          "use strict";
          function EC(e) {
            ...
            "string" == typeof e &&
              (assert(elliptic.curves.hasOwnProperty(e), "Unknown curve " + e),
              (e = elliptic.curves[e])),
              e instanceof elliptic.curves.PresetCurve && (e = { curve: e }),
          ...
          (module.exports = EC),
            ...
            (EC.prototype.sign = function (e, t, r, n) {
              ...
              for (
                ...
                if (
                  !(
                    (a = this._truncateToN(a, !0)).cmpn(1) <= 0 || a.cmp(c) >= 0
                  )
                ) {
                  var p = this.g.mul(a);
                  if (!p.isInfinity()) {
                    ...
                    if (0 !== v.cmpn(0)) {
                      ...
                      if (0 !== (y = y.umod(this.n)).cmpn(0)) {
                        var l =
                          (p.getY().isOdd() ? 1 : 0) | (0 !== m.cmp(v) ? 2 : 0);
                        return (
                          n.canonical &&
                            y.cmp(this.nh) > 0 &&
                            ((y = this.n.sub(y)), (l ^= 1)),
                          new Signature({ r: v, s: y, recoveryParam: l })
                        );
                      }
                    }
                  }
            ...
            (EC.prototype.verify = function (e, t, r, n) {
              ...
              if (!this.curve._maxwellTrick)
                return (
                  !(h = this.g.mulAdd(o, r.getPublic(), c)).isInfinity() &&
                  0 === h.getX().umod(this.n).cmp(i)
                );
              var h = this.g.jmulAdd(o, r.getPublic(), c);
              return !h.isInfinity() && h.eqXToP(i);
            }),
            (EC.prototype.recoverPubKey = function (e, t, r, n) {
              assert((3 & r) === r, "The recovery param is more than two bits"),
                (t = new Signature(t, n));
              var i = this.n,
                s = new BN(e),
                u = t.r,
              ...
              u = h
                ? this.curve.pointFromX(u.add(this.curve.n), c)
                : this.curve.pointFromX(u, c);
              var a = t.r.invm(i),
            ...
            (EC.prototype.getKeyRecoveryParam = function (e, t, r, n) {
              if (null !== (t = new Signature(t, n)).recoveryParam)
      ...
      22: [
        function (require, module, exports) {
          ...
          (module.exports = KeyPair),
            (KeyPair.fromPublic = function (i, t, e) {
              return t instanceof KeyPair
                ? t
                : new KeyPair(i, { pub: t, pubEnc: e });
            }),
            (KeyPair.fromPrivate = function (i, t, e) {
              return t instanceof KeyPair
                ? t
                : new KeyPair(i, { priv: t, privEnc: e });
            }),
            (KeyPair.prototype.validate = function () {
              ...
              return i.isInfinity()
                ...
                : i.validate()
                ? i.mul(this.ec.curve.n).isInfinity()
            ...
            (KeyPair.prototype.getPublic = function (i, t) {
              return (
                ...
                t ? this.pub.encode(t, i) : this.pub
              );
            }),
              ...
              if (i.x || i.y)
                return (
                  "mont" === this.ec.curve.type
                    ? assert(i.x, "Need x coordinate")
                    : ("short" !== this.ec.curve.type &&
                        "edwards" !== this.ec.curve.type) ||
                      assert(i.x && i.y, "Need both x and y coordinate"),
                  void (this.pub = this.ec.curve.point(i.x, i.y))
                );
      ...
      23: [
        function (require, module, exports) {
          ...
          function getLength(t, r) {
            var e = t[r.place++];
            if (!(128 & e)) return e;
            for (var n = 15 & e, i = 0, a = 0, c = r.place; a < n; a++, c++)
              (i <<= 8), (i |= t[c]);
            return (r.place = c), i;
          }
          function rmPadding(t) {
            for (
              var r = 0, e = t.length - 1;
              !t[r] && !(128 & t[r + 1]) && r < e;
          ...
          (module.exports = Signature),
            (Signature.prototype._importDER = function (t, r) {
              t = utils.toArray(t, r);
              var e = new Position();
            ...
            (Signature.prototype.toDER = function (t) {
              ...
              for (
                ...
                e = e.slice(1);
              var n = [2];
              constructLength(n, r.length),
                (n = n.concat(r)).push(2),
                constructLength(n, e.length);
              var i = n.concat(e),
                a = [48];
              return (
                constructLength(a, i.length),
                (a = a.concat(i)),
                utils.encode(a, t)
              );
            });
      ...
      24: [
        function (require, module, exports) {
          ...
          function EDDSA(t) {
            if (
              (assert("ed25519" === t, "only tested with ed25519 so far"),
          ...
          (module.exports = EDDSA),
            (EDDSA.prototype.sign = function (t, e) {
              t = parseBytes(t);
        ...
        { "../../elliptic": 14, "./key": 25, "./signature": 26, "hash.js": 37 },
      ],
      25: [
        function (require, module, exports) {
          "use strict";
      ...
      26: [
        function (require, module, exports) {
          ...
          function Signature(e, t) {
            (this.eddsa = e),
              "object" != typeof t && (t = parseBytes(t)),
              Array.isArray(t) &&
                (t = {
                  R: t.slice(0, e.encodingLength),
        ...
        function (require, module, exports) {
          ...
          function getNAF(t, r) {
            for (
              ...
              i.push(s);
              for (
                var l = 0 !== e.cmpn(0) && 0 === e.andln(n - 1) ? r + 1 : 1,
                  o = 1;
                o < l;
                o++
              )
      ...
      31: [
            ...
            var ethUtil = require("ethereumjs-util"),
              ...
              Transaction = (function () {
                function e(t) {
                  ...
                  ethUtil.defineProperties(this, i, t),
                ...
                return (
                  ...
                  (e.prototype.getSenderAddress = function () {
                    ...
                    return (
                      (this._from = ethUtil.publicToAddress(e)), this._from
                    );
                  }),
                  ...
                  (e.prototype.verifySignature = function () {
                    var e = this.hash(!1);
                    if (this._homestead && 1 === new BN(this.s).cmp(N_DIV_2))
                      return !1;
                    try {
                  ...
                  (e.prototype.sign = function (e) {
                    ...
                    this._chainId > 0 && (i.v += 2 * this._chainId + 8),
                      Object.assign(this, i);
                  }),
                  (e.prototype.getDataFee = function () {
                    for (
                      var e = this.raw[5], t = new BN(0), i = 0;
                      i < e.length;
                      i++
                    )
                      0 === e[i]
                        ? t.iaddn(fees.txDataZeroGas.v)
                        : t.iaddn(fees.txDataNonZeroGas.v);
                    return t;
                  }),
                  ...
                  (e.prototype.validate = function (e) {
                    ...
                    return (
                      ...
                      this.getBaseFee().cmp(new BN(this.gasLimit)) > 0 &&
                        t.push([
        ...
        { buffer: 8, "ethereum-common/params.json": 30, "ethereumjs-util": 32 },
      ],
      32: [
        function (require, module, exports) {
          (function (Buffer) {
            ...
            Object.assign(exports, require("ethjs-util")),
              ...
              (exports.SHA3_RLP_ARRAY = Buffer.from(
                exports.SHA3_RLP_ARRAY_S,
                "hex"
              )),
              (exports.SHA3_RLP_S =
              ...
              (exports.setLengthLeft = exports.setLength =
                function (e, r, t) {
              ...
              (exports.unpad = exports.stripZeros =
                function (e) {
                  for (
                    var r = (e = exports.stripHexPrefix(e))[0];
              ...
              (exports.toBuffer = function (e) {
                if (!Buffer.isBuffer(e))
                  if (Array.isArray(e)) e = Buffer.from(e);
                    ...
                    e = exports.isHexString(e)
                      ? Buffer.from(
                          exports.padToEven(exports.stripHexPrefix(e)),
                          "hex"
                        )
                      : Buffer.from(e);
              ...
              (exports.isValidPublic = function (e, r) {
                return 64 === e.length
                  ? secp256k1.publicKeyVerify(
                      Buffer.concat([Buffer.from([4]), e])
                    )
                  : !!r && secp256k1.publicKeyVerify(e);
              }),
              (exports.pubToAddress = exports.publicToAddress =
                function (e, r) {
                  return (
                    (e = exports.toBuffer(e)),
                    r &&
                      64 !== e.length &&
                      (e = secp256k1.publicKeyConvert(e, !1).slice(1)),
                    assert(64 === e.length),
                    exports.sha3(e).slice(-20)
                  );
                });
            var privateToPublic = (exports.privateToPublic = function (e) {
              return (
                (e = exports.toBuffer(e)),
                secp256k1.publicKeyCreate(e, !1).slice(1)
              );
            });
            (exports.importPublic = function (e) {
              return (
                64 !== (e = exports.toBuffer(e)).length &&
                  (e = secp256k1.publicKeyConvert(e, !1).slice(1)),
                e
              );
            }),
              (exports.ecsign = function (e, r) {
                var t = secp256k1.sign(e, r),
                  f = {};
                return (
                  (f.r = t.signature.slice(0, 32)),
                  (f.s = t.signature.slice(32, 64)),
                  (f.v = t.recovery + 27),
                  f
                );
              }),
              (exports.hashPersonalMessage = function (e) {
                ...
                return exports.sha3(Buffer.concat([r, e]));
              }),
              (exports.ecrecover = function (e, r, t, f) {
                var o = Buffer.concat(
                    [exports.setLength(t, 32), exports.setLength(f, 32)],
                    64
                  ),
                  s = r - 27;
                if (0 !== s && 1 !== s)
                  throw new Error("Invalid signature v value");
                var n = secp256k1.recover(e, o, s);
              ...
              (exports.toRpcSig = function (e, r, t) {
                ...
                return exports.bufferToHex(
                  Buffer.concat([
                    ...
                    exports.setLengthLeft(t, 32),
                    exports.toBuffer(e - 27),
                  ])
                );
              }),
              (exports.fromRpcSig = function (e) {
                if (65 !== (e = exports.toBuffer(e)).length)
                  throw new Error("Invalid signature length");
                var r = e[64];
                return (
                  r < 27 && (r += 27),
                  { v: r, r: e.slice(0, 32), s: e.slice(32, 64) }
                );
              }),
              ...
              (exports.toChecksumAddress = function (e) {
                ...
                for (
                  var r = exports.sha3(e).toString("hex"), t = "0x", f = 0;
                  f < e.length;
                  f++
                )
                  parseInt(r[f], 16) >= 8
              ...
              (exports.isValidChecksumAddress = function (e) {
                return (
                  exports.isValidAddress(e) &&
                  exports.toChecksumAddress(e) === e
                );
              }),
              (exports.generateAddress = function (e, r) {
                return (
                  (e = exports.toBuffer(e)),
                  (r = new BN(r)),
                  (r = r.isZero() ? null : Buffer.from(r.toArray())),
                  exports.rlphash([e, r]).slice(-20)
                );
              }),
              ...
              (exports.addHexPrefix = function (e) {
                return "string" != typeof e
                  ? e
                  : exports.isHexPrefixed(e)
                  ? e
                  : "0x" + e;
              }),
              (exports.isValidSignature = function (e, r, t, f) {
                var o = new BN(
                    "7fffffffffffffffffffffffffffffff5d576e7357a4501ddfe92f46681b20a0",
                    16
                  ),
                ...
                return (
                  ...
                  ((r = new BN(r)),
                  (t = new BN(t)),
                  !(r.isZero() || r.gt(s) || t.isZero() || t.gt(s)) &&
                    (!1 !== f || 1 !== new BN(t).cmp(o)))
                );
              }),
              ...
              (exports.defineProperties = function (e, r, t) {
                if (
                  ...
                  r.forEach(function (r, t) {
                    ...
                    function o(f) {
                      "00" !== (f = exports.toBuffer(f)).toString("hex") ||
                        r.allowZero ||
                        (f = Buffer.allocUnsafe(0)),
                        r.allowLess && r.length
                          ? ((f = exports.stripZeros(f)),
                            assert(
                              r.length >= f.length,
                              "The field " +
                                r.name +
                  ...
                  if (
                    ("string" == typeof t &&
                      (t = Buffer.from(exports.stripHexPrefix(t), "hex")),
                    Buffer.isBuffer(t) && (t = rlp.decode(t)),
                    Array.isArray(t))
                  ) {
                    ...
                    r.forEach(function (r) {
                      -1 !== f.indexOf(r.name) && (e[r.name] = t[r.name]),
                        -1 !== f.indexOf(r.alias) && (e[r.alias] = t[r.alias]);
                    });
                  }
              });
          }.call(this, require("buffer").Buffer));
          ...
          (function (Buffer) {
            ...
            (exports.MAX_INTEGER = new BN(
              ...
              (exports.intToHex = function (e) {
                assert(e % 1 == 0, "number is not a integer"),
                  assert(e >= 0, "number must be positive");
                var r = e.toString(16);
              ...
              (exports.bufferToHex = function (e) {
                return 0 === (e = exports.toBuffer(e)).length
                  ? 0
                  : "0x" + e.toString("hex");
              }),
              (exports.fromSigned = function (e) {
            ...
            (exports.importPublic = function (e) {
              ...
              (exports.toRpcSig = function (e, r, t) {
                return exports.bufferToHex(
                  Buffer.concat([r, t, exports.toBuffer(e - 27)])
                );
              }),
              (exports.fromRpcSig = function (e) {
              ...
              (exports.generateAddress = function (e, r) {
                return (
                  (e = exports.toBuffer(e)),
                  (r = new BN(r)),
                  (r = r.isZero() ? null : new Buffer(r.toArray())),
                  exports.rlphash([e, r]).slice(-20)
                );
              }),
              (exports.isPrecompiled = function (e) {
              ...
              (exports.defineProperties = function (e, r, t) {
                if (
                  ...
                  if (
                    ("string" == typeof t &&
                      (t = new Buffer(exports.stripHexPrefix(t), "hex")),
                    Buffer.isBuffer(t) && (t = rlp.decode(t)),
                    Array.isArray(t))
                  ) {
                    if (t.length > e._fields.length)
      ...
      34: [
        function (require, module, exports) {
          (function (Buffer) {
            ...
            function toUtf8(r) {
              return new Buffer(
                padToEven(stripHexPrefix(r).replace(/^0+|0+$/g, "")),
                "hex"
              ).toString("utf8");
            }
            function toAscii(r) {
            ...
            function fromUtf8(r) {
              return (
                "0x" +
                padToEven(new Buffer(r, "utf8").toString("hex")).replace(
                  /^0+|0+$/g,
                  ""
                )
              );
            ...
            function isHexString(r, e) {
              return (
                !("string" != typeof r || !r.match(/^0x[0-9A-Fa-f]*$/)) &&
                (!e || r.length === 2 + 2 * e)
              );
            }
        ...
        { buffer: 8, "is-hex-prefixed": 53, "strip-hex-prefix": 99 },
      ],
      35: [
        function (require, module, exports) {
          ...
          (module.exports = EventEmitter),
              ...
              return (
                ...
                this._events.newListener &&
                  this.emit(
                    "newListener",
                    e,
                    isFunction(t.listener) ? t.listener : t
                  ),
                this._events[e]
                ...
                isObject(this._events[e]) &&
                  ...
                  (i = isUndefined(this._maxListeners)
            ...
            (EventEmitter.prototype.removeAllListeners = function (e) {
              ...
              if (((i = this._events[e]), isFunction(i)))
                this.removeListener(e, i);
              else if (i)
      ...
      36: [
        function (require, module, exports) {
          (function (Buffer) {
            ...
            inherits(HashBase, Transform),
              (HashBase.prototype._transform = function (t, e, r) {
                var s = null;
                try {
              ...
              (HashBase.prototype.update = function (t, e) {
                ...
                for (
                  var r = this._block, s = 0;
                  this._blockOffset + t.length - s >= this._blockSize;
        ...
        { buffer: 8, inherits: 51, stream: 97 },
      ],
      37: [
        function (require, module, exports) {
          var hash = exports;
      ...
      38: [
        function (require, module, exports) {
          ...
          (exports.BlockHash = BlockHash),
            (BlockHash.prototype.update = function (t, i) {
              if (
                ((t = utils.toArray(t, i)),
                this.pending
                ...
                (this.pending = t.slice(t.length - n, t.length)),
                  ...
                  (t = utils.join32(t, 0, t.length - n, this.endian));
                for (var s = 0; s < t.length; s += this._delta32)
                  this._update(t, s, s + this._delta32);
              }
              return this;
            }),
        ...
        { "./utils": 48, "minimalistic-assert": 63 },
      ],
      39: [
        function (require, module, exports) {
          "use strict";
      ...
      40: [
        function (require, module, exports) {
          ...
          utils.inherits(RIPEMD160, BlockHash),
            ...
            (RIPEMD160.prototype._update = function (t, h) {
              for (
                var i = this.h[0],
                  u = this.h[1],
                  o = this.h[2],
                ...
                var E = sum32(
                  rotl32(sum32_4(i, f(D, u, o, e), t[r[D] + h], K(D)), s[D]),
                  l
                );
                (i = l),
                  (l = e),
                  ...
                  (E = sum32(
                    rotl32(
                      sum32_4(n, f(79 - D, m, c, a), t[rh[D] + h], Kh(D)),
                      sh[D]
                    ),
                    _
                  )),
              ...
              (E = sum32_3(this.h[1], o, a)),
                (this.h[1] = sum32_3(this.h[2], e, _)),
                (this.h[2] = sum32_3(this.h[3], l, n)),
                (this.h[3] = sum32_3(this.h[4], i, m)),
                (this.h[4] = sum32_3(this.h[0], u, c)),
                (this.h[0] = E);
            }),
      ...
      42: [
        function (require, module, exports) {
          ...
          utils.inherits(SHA1, BlockHash),
            ...
            (SHA1.padLength = 64),
            (SHA1.prototype._update = function (t, h) {
              for (var s = this.W, i = 0; i < 16; i++) s[i] = t[h + i];
              for (; i < s.length; i++)
                s[i] = rotl32(s[i - 3] ^ s[i - 8] ^ s[i - 14] ^ s[i - 16], 1);
              var o = this.h[0],
                r = this.h[1],
                u = this.h[2],
                e = this.h[3],
              ...
              (this.h[0] = sum32(this.h[0], o)),
                (this.h[1] = sum32(this.h[1], r)),
                (this.h[2] = sum32(this.h[2], u)),
                (this.h[3] = sum32(this.h[3], e)),
                (this.h[4] = sum32(this.h[4], l));
            }),
      ...
      44: [
        function (require, module, exports) {
          ...
          utils.inherits(SHA256, BlockHash),
            ...
            (SHA256.padLength = 64),
            (SHA256.prototype._update = function (s, h) {
              ...
              var m = this.h[0],
                ...
                l = this.h[7];
              for (
                assert(this.k.length === t.length), i = 0;
                i < t.length;
                i++
              ) {
              ...
              (this.h[0] = sum32(this.h[0], m)),
                (this.h[1] = sum32(this.h[1], o)),
                (this.h[2] = sum32(this.h[2], u)),
                (this.h[3] = sum32(this.h[3], e)),
                (this.h[4] = sum32(this.h[4], n)),
                (this.h[5] = sum32(this.h[5], a)),
                (this.h[6] = sum32(this.h[6], r)),
                (this.h[7] = sum32(this.h[7], l));
            }),
      ...
      46: [
        function (require, module, exports) {
          ...
          function s0_512_hi(t, h) {
            var r =
              rotr64_hi(t, h, 28) ^ rotr64_hi(h, t, 2) ^ rotr64_hi(h, t, 7);
            return r < 0 && (r += 4294967296), r;
          }
          function s0_512_lo(t, h) {
            var r =
              rotr64_lo(t, h, 28) ^ rotr64_lo(h, t, 2) ^ rotr64_lo(h, t, 7);
            return r < 0 && (r += 4294967296), r;
          }
          function s1_512_hi(t, h) {
            var r =
              rotr64_hi(t, h, 14) ^ rotr64_hi(t, h, 18) ^ rotr64_hi(h, t, 9);
            return r < 0 && (r += 4294967296), r;
          }
          function s1_512_lo(t, h) {
            var r =
              rotr64_lo(t, h, 14) ^ rotr64_lo(t, h, 18) ^ rotr64_lo(h, t, 9);
            return r < 0 && (r += 4294967296), r;
          }
          ...
          function g1_512_hi(t, h) {
            var r =
              rotr64_hi(t, h, 19) ^ rotr64_hi(h, t, 29) ^ shr64_hi(t, h, 6);
            return r < 0 && (r += 4294967296), r;
          }
          function g1_512_lo(t, h) {
            var r =
              rotr64_lo(t, h, 19) ^ rotr64_lo(h, t, 29) ^ shr64_lo(t, h, 6);
            return r < 0 && (r += 4294967296), r;
          }
          var utils = require("../utils"),
            common = require("../common"),
          ...
          utils.inherits(SHA512, BlockHash),
            ...
            (SHA512.prototype._prepareBlock = function (t, h) {
              ...
              for (; i < r.length; i += 2) {
                var s = g1_512_hi(r[i - 4], r[i - 3]),
                  ...
                  e = r[i - 32],
                  m = r[i - 31];
                (r[i] = sum64_4_hi(s, _, o, u, l, n, e, m)),
                  (r[i + 1] = sum64_4_lo(s, _, o, u, l, n, e, m));
              }
            }),
            (SHA512.prototype._update = function (t, h) {
              ...
              for (var p = 0; p < r.length; p += 2) {
                ...
                (A = s0_512_hi(i, s)),
                  (k = s0_512_lo(i, s)),
                  (B = maj64_hi(i, s, _, o, u, l)),
                  (d = maj64_lo(i, s, _, o, u, l));
        ...
        { "../common": 38, "../utils": 48, "minimalistic-assert": 63 },
      ],
      47: [
        function (require, module, exports) {
          "use strict";
      ...
      48: [
        function (require, module, exports) {
          ...
          function toArray(r, t) {
            ...
            if ("string" == typeof r)
              if (t) {
                if ("hex" === t)
                  for (
                    (r = r.replace(/[^a-z0-9]+/gi, "")).length % 2 != 0 &&
                      (r = "0" + r),
                      n = 0;
                    n < r.length;
                    n += 2
                  )
                    o.push(parseInt(r[n] + r[n + 1], 16));
              } else
            ...
            else for (n = 0; n < r.length; n++) o[n] = 0 | r[n];
            return o;
          }
          function toHex(r) {
            for (var t = "", o = 0; o < r.length; o++)
              t += zero2(r[o].toString(16));
            return t;
          }
          function htonl(r) {
            return (
          ...
          function split32(r, t) {
            for (
              var o = new Array(4 * r.length), n = 0, e = 0;
              n < r.length;
              n++, e += 4
            ) {
              var s = r[n];
        ...
        { inherits: 51, "minimalistic-assert": 63 },
      ],
      49: [
        function (require, module, exports) {
          "use strict";
          ...
          (module.exports = HmacDRBG),
            (HmacDRBG.prototype._init = function (t, e, i) {
            ...
            (HmacDRBG.prototype.reseed = function (t, e, i, s) {
              "string" != typeof e && ((s = i), (i = e), (e = null)),
                (t = utils.toArray(t, e)),
                (i = utils.toArray(i, s)),
                assert(
            ...
            (HmacDRBG.prototype.generate = function (t, e, i, s) {
              ...
              "string" != typeof e && ((s = i), (i = e), (e = null)),
                i && ((i = utils.toArray(i, s || "hex")), this._update(i));
        ...
        function (require, module, exports) {
          (function (global) {
            !(function (r, e) {
              ...
              n &&
                (r = global).JS_SHA3_TEST &&
                (r.navigator = { userAgent: "Chrome" });
              var t =
                  (r.JS_SHA3_TEST || !n) &&
                ...
                v = function (e, n, c) {
                  ...
                  do {
                    ...
                    if (s)
                      for (l = Hr; Er < Jr && l < wr; ++Er)
                        i[l >> 2] |= e[Er] << f[3 & l++];
                    else
                      for (l = Hr; Er < Jr && l < wr; ++Er)
                        (h = e.charCodeAt(Er)) < 128
                          ? (i[l >> 2] |= h << f[3 & l++])
                          : h < 2048
                          ? ((i[l >> 2] |= (192 | (h >> 6)) << f[3 & l++]),
                            (i[l >> 2] |= (128 | (63 & h)) << f[3 & l++]))
                          : h < 55296 || h >= 57344
                          ? ((i[l >> 2] |= (224 | (h >> 12)) << f[3 & l++]),
                            (i[l >> 2] |=
                              (128 | ((h >> 6) & 63)) << f[3 & l++]),
                            (i[l >> 2] |= (128 | (63 & h)) << f[3 & l++]))
                          : ((h =
                              65536 +
                              (((1023 & h) << 10) |
                                (1023 & e.charCodeAt(++Er)))),
                            (i[l >> 2] |= (240 | (h >> 18)) << f[3 & l++]),
                            (i[l >> 2] |=
                              (128 | ((h >> 12) & 63)) << f[3 & l++]),
                            (i[l >> 2] |=
                              (128 | ((h >> 6) & 63)) << f[3 & l++]),
                    ...
                    for (
                      Hr = l - wr,
                        Er == Jr && ((i[l >> 2] |= c[3 & l]), ++Er),
                        k = i[br],
                        Er > Jr &&
                          l < wr &&
                          ((i[br - 1] |= 2147483648), (Cr = !0)),
                        l = 0;
                      l < br;
                      ++l
                    )
                      _[l] ^= i[l];
                    for (d = 0; d < 48; d += 2)
                      (v = _[0] ^ _[10] ^ _[20] ^ _[30] ^ _[40]),
                        (g = _[1] ^ _[11] ^ _[21] ^ _[31] ^ _[41]),
                        (T = _[2] ^ _[12] ^ _[22] ^ _[32] ^ _[42]),
                        (m = _[3] ^ _[13] ^ _[23] ^ _[33] ^ _[43]),
                        (p = _[4] ^ _[14] ^ _[24] ^ _[34] ^ _[44]),
                        (y = _[5] ^ _[15] ^ _[25] ^ _[35] ^ _[45]),
                        (C = _[6] ^ _[16] ^ _[26] ^ _[36] ^ _[46]),
                        (E = _[7] ^ _[17] ^ _[27] ^ _[37] ^ _[47]),
                        (A =
                          (H = _[8] ^ _[18] ^ _[28] ^ _[38] ^ _[48]) ^
                          ((T << 1) | (m >>> 31))),
                        (S =
                          (J = _[9] ^ _[19] ^ _[29] ^ _[39] ^ _[49]) ^
                          ((m << 1) | (T >>> 31))),
                        (_[0] ^= A),
                        (_[1] ^= S),
                        (_[10] ^= A),
      ...
      58: [
          ...
          module.exports = function (t) {
            function i(i, e, r, s, a) {
              Transform.call(this, a),
                ...
                (this._options = a),
                (this._state = new t()),
                this._state.initialize(i, e),
                (this._finalized = !1);
            }
            return (
              inherits(i, Transform),
              (i.prototype._transform = function (t, i, e) {
                var r = null;
                try {
                  this.update(t, i);
                } catch (t) {
              ...
              (i.prototype.update = function (t, i) {
                ...
                if (this._finalized) throw new Error("Digest already called");
                return (
                  Buffer.isBuffer(t) || (t = Buffer.from(t, i)),
              ...
              (i.prototype.digest = function (t) {
                ...
                return (
                  void 0 !== t && (i = i.toString(t)), this._resetState(), i
                );
              }),
        ...
        { inherits: 51, "safe-buffer": 82, stream: 97 },
      ],
      59: [
        function (require, module, exports) {
          "use strict";
          ...
          exports.p1600 = function (r) {
            for (var N = 0; N < 24; ++N) {
              ...
              (r[0] = sr ^ (~pr & wr)),
                ...
                (r[48] = hr ^ (~kr & Ir)),
                (r[49] = jr ^ (~lr & Jr)),
                (r[0] ^= P1600_ROUND_CONSTANTS[2 * N]),
                (r[1] ^= P1600_ROUND_CONSTANTS[2 * N + 1]);
            }
          };
        },
        {},
      ...
      61: [
        function (require, module, exports) {
          ...
          (Keccak.prototype.initialize = function (t, e) {
              ...
              for (var e = 0; e < t.length; ++e)
                (this.state[~~(this.count / 4)] ^=
                  ...
                  this.count === this.blockSize &&
                    (keccakState.p1600(this.state), (this.count = 0));
            }),
            ...
            (Keccak.prototype.squeeze = function (t) {
              ...
              for (var e = Buffer.alloc(t), s = 0; s < t; ++s)
                (e[s] =
        ...
        { "./keccak-state-unroll": 60, "safe-buffer": 82 },
      ],
      62: [
        function (require, module, exports) {
      ...
      63: [
        function (require, module, exports) {
          ...
          (module.exports = assert),
            (assert.equal = function (r, e, s) {
              if (r != e)
                throw new Error(s || "Assertion failed: " + r + " != " + e);
            });
        },
        {},
      ],
          ...
          (function (process) {
            ...
            function nextTick(e, n, c, r) {
              ...
              switch (o) {
                ...
                default:
                  for (s = new Array(o - 1), t = 0; t < s.length; )
                    s[t++] = arguments[t];
                  return process.nextTick(function () {
                    e.apply(null, s);
                  });
      ...
      69: [
        ...
        { "./_stream_transform": 71, "core-util-is": 10, inherits: 51 },
      ],
      70: [
        function (require, module, exports) {
          (function (process, global) {
            ...
            function howMuchToRead(e, t) {
              return e <= 0 || (0 === t.length && t.ended)
                ...
                ? t.flowing && t.length
                  ...
                  : t.length
                : (e > t.highWaterMark &&
                    (t.highWaterMark = computeNewHighWaterMark(e)),
                  e <= t.length
                    ? e
                    : t.ended
                    ? t.length
            ...
            function emitReadable(e) {
              ...
              (t.needReadable = !1),
                t.emittedReadable ||
                  ...
                  (t.emittedReadable = !0),
                  t.sync
                    ? processNextTick(emitReadable_, e)
                    : emitReadable_(e));
            }
            ...
            function maybeReadMore(e, t) {
              t.readingMore ||
                ((t.readingMore = !0), processNextTick(maybeReadMore_, e, t));
            }
            function maybeReadMore_(e, t) {
              for (
                ...
                (debug("maybeReadMore read 0"), e.read(0), r !== t.length);
            ...
            function resume(e, t) {
              t.resumeScheduled ||
                ((t.resumeScheduled = !0), processNextTick(resume_, e, t));
            }
            ...
            function copyFromBufferString(e, t) {
              ...
              for (e -= a.length; (r = r.next); ) {
                ...
                if (
                  (d === i.length ? (a += i) : (a += i.slice(0, e)),
                  0 === (e -= d))
                ) {
                  d === i.length
                    ? (++n,
                      r.next ? (t.head = r.next) : (t.head = t.tail = null))
                    : ((t.head = r), (r.data = i.slice(d)));
                  break;
                }
                ++n;
              }
            ...
            function endReadable(e) {
              ...
              t.endEmitted ||
                ((t.ended = !0), processNextTick(endReadableNT, t, e));
            }
            ...
            (Readable.prototype.read = function (e) {
              ...
              debug("need readable", n),
                (0 === t.length || t.length - e < t.highWaterMark) &&
                  debug("length less than watermark", (n = !0)),
                t.ended || t.reading
              ...
              (Readable.prototype.pipe = function (e, t) {
                ...
                function i(t) {
                  debug("ondata"),
                    ...
                    !1 !== e.write(t) ||
                      b ||
                      (((1 === h.pipesCount && h.pipes === e) ||
                        (h.pipesCount > 1 && -1 !== indexOf(h.pipes, e))) &&
                        !c &&
                        (debug(
                ...
                var f =
                  ...
                  e !== process.stderr
                    ? n
                    : s;
                h.endEmitted ? processNextTick(f) : l.once("end", f),
                  e.on("unpipe", r);
                var p = pipeOnDrain(l);
                e.on("drain", p);
                var c = !1,
                ...
                return (
                  ...
                  e.once("finish", u),
                  e.emit("pipe", l),
                  h.flowing || (debug("pipe resume"), l.resume()),
                  e
                );
              }),
              ...
              (Readable.prototype.resume = function () {
                ...
                return (
                  e.flowing ||
                    (debug("resume"), (e.flowing = !0), resume(this, e)),
                  this
                );
              }),
              ...
              (Readable.prototype.wrap = function (e) {
                ...
                for (var i = 0; i < kProxyEvents.length; i++)
                  e.on(kProxyEvents[i], n.emit.bind(n, kProxyEvents[i]));
                return (
                  (n._read = function (t) {
      ...
      71: [
        ...
        { "./_stream_duplex": 68, "core-util-is": 10, inherits: 51 },
      ],
      72: [
        function (require, module, exports) {
          (function (process, global) {
            ...
            function validChunk(e, t, r, i) {
              ...
              return (
                ...
                o && (e.emit("error", o), processNextTick(i, o), (n = !1)),
                n
              );
            }
              ...
              if (e._writev && r && r.next) {
                ...
                for (; r; ) {
                  var f = r.chunk,
                    ...
                    l = r.callback;
                  if (
                    (doWrite(e, t, !1, t.objectMode ? 1 : f.length, f, u, l),
                    (r = r.next),
                    t.writing)
                  )
                    break;
              ...
              (Writable.prototype.write = function (e, t, r) {
                ...
                return (
                  ...
                  i.ended
                    ...
                    : (o || validChunk(this, i, e, r)) &&
                      (i.pendingcb++, (n = writeOrBuffer(this, i, o, e, t, r))),
                  n
                );
              }),
          ...
          module.exports = (function () {
            ...
            return (
              ...
              (t.prototype.join = function (t) {
                ...
                for (var e = this.head, h = "" + e.data; (e = e.next); )
                  h += t + e.data;
                return h;
              }),
              (t.prototype.concat = function (t) {
                ...
                for (
                  var e = Buffer.allocUnsafe(t >>> 0), h = this.head, n = 0;
                  h;

                )
                  copyBuffer(h.data, e, n), (n += h.data.length), (h = h.next);
                return e;
              }),
              t
            );
            ...
            i || a
              ? e
                ...
                : !t ||
                  ...
                  processNextTick(emitErrorNT, this, t)
      ...
      80: [
          ...
          (function (Buffer) {
            ...
            inherits(RIPEMD160, HashBase),
              (RIPEMD160.prototype._update = function () {
                for (var t = new Array(16), r = 0; r < 16; ++r)
                  t[r] = this._block.readInt32LE(4 * r);
                var n = this._a,
                  o = this._b,
                  f = this._c,
                  l = this._d,
                ...
                (i = fn1(
                  ...
                  (o = fn2(
                    ...
                    (f = fn2(
                      f,
                      (l = fn2(l, i, n, o, f, t[4], 1518500249, 6)),
                      i,
                      (n = rotl(n, 10)),
                      o,
                      t[13],
                  ...
                  (l = fn2(
                    ...
                    (i = fn2(
                      i,
                      (n = fn2(n, o, f, l, i, t[10], 1518500249, 11)),
                      o,
                      (f = rotl(f, 10)),
                      l,
                      t[6],
                  ...
                  (n = fn2(
                    ...
                    (o = fn2(
                      o,
                      (f = fn2(f, l, i, n, o, t[3], 1518500249, 15)),
                      l,
                      (i = rotl(i, 10)),
                      n,
                      t[12],
                  ...
                  (f = fn2(
                    ...
                    (l = fn2(
                      l,
                      (i = fn2(i, n, o, f, l, t[9], 1518500249, 15)),
                      n,
                      (o = rotl(o, 10)),
                      f,
                      t[5],
                  ...
                  (i = fn2(
                    ...
                    (n = fn2(
                      n,
                      (o = fn2(o, f, l, i, n, t[14], 1518500249, 7)),
                      f,
                      (l = rotl(l, 10)),
                      i,
                      t[11],
                  ...
                  (o = fn3(
                    ...
                    (f = fn3(
                      f,
                      (l = fn3(l, i, n, o, f, t[3], 1859775393, 11)),
                      i,
                      (n = rotl(n, 10)),
                      o,
                      t[10],
                  ...
                  (l = fn3(
                    ...
                    (i = fn3(
                      i,
                      (n = fn3(n, o, f, l, i, t[4], 1859775393, 7)),
                      o,
                      (f = rotl(f, 10)),
                      l,
                      t[9],
                  ...
                  (n = fn3(
                    ...
                    (o = fn3(
                      o,
                      (f = fn3(f, l, i, n, o, t[8], 1859775393, 13)),
                      l,
                      (i = rotl(i, 10)),
                      n,
                      t[1],
                  ...
                  (f = fn3(
                    ...
                    (l = fn3(
                      l,
                      (i = fn3(i, n, o, f, l, t[7], 1859775393, 8)),
                      n,
                      (o = rotl(o, 10)),
                      f,
                      t[0],
                  ...
                  (i = fn3(
                    ...
                    (n = fn3(
                      n,
                      (o = fn3(o, f, l, i, n, t[13], 1859775393, 5)),
                      f,
                      (l = rotl(l, 10)),
                      i,
                      t[11],
                  ...
                  (o = fn4(
                    ...
                    (f = fn4(
                      f,
                      (l = fn3(l, i, n, o, f, t[12], 1859775393, 5)),
                      i,
                      (n = rotl(n, 10)),
                      o,
                      t[1],
                  ...
                  (l = fn4(
                    ...
                    (i = fn4(
                      i,
                      (n = fn4(n, o, f, l, i, t[11], 2400959708, 14)),
                      o,
                      (f = rotl(f, 10)),
                      l,
                      t[10],
                  ...
                  (n = fn4(
                    ...
                    (o = fn4(
                      o,
                      (f = fn4(f, l, i, n, o, t[8], 2400959708, 15)),
                      l,
                      (i = rotl(i, 10)),
                      n,
                      t[12],
                  ...
                  (f = fn4(
                    ...
                    (l = fn4(
                      l,
                      (i = fn4(i, n, o, f, l, t[13], 2400959708, 9)),
                      n,
                      (o = rotl(o, 10)),
                      f,
                      t[3],
                  ...
                  (i = fn4(
                    ...
                    (n = fn4(
                      n,
                      (o = fn4(o, f, l, i, n, t[15], 2400959708, 6)),
                      f,
                      (l = rotl(l, 10)),
                      i,
                      t[14],
                  ...
                  (o = fn5(
                    ...
                    (f = fn4(
                      f,
                      (l = fn4(l, i, n, o, f, t[6], 2400959708, 5)),
                      i,
                      (n = rotl(n, 10)),
                      o,
                      t[2],
                  ...
                  (l = fn5(
                    ...
                    (i = fn5(
                      i,
                      (n = fn5(n, o, f, l, i, t[0], 2840853838, 15)),
                      o,
                      (f = rotl(f, 10)),
                      l,
                      t[5],
                  ...
                  (n = fn5(
                    ...
                    (o = fn5(
                      o,
                      (f = fn5(f, l, i, n, o, t[7], 2840853838, 6)),
                      l,
                      (i = rotl(i, 10)),
                      n,
                      t[12],
                  ...
                  (f = fn5(
                    ...
                    (l = fn5(
                      l,
                      (i = fn5(i, n, o, f, l, t[10], 2840853838, 12)),
                      n,
                      (o = rotl(o, 10)),
                      f,
                      t[14],
                  ...
                  (i = fn5(
                    ...
                    (n = fn5(
                      n,
                      (o = fn5(o, f, l, i, n, t[3], 2840853838, 13)),
                      f,
                      (l = rotl(l, 10)),
                      i,
                      t[8],
                  ...
                  (o = fn5(
                    ...
                    (f = fn5(
                      f,
                      (l = fn5(l, i, n, o, f, t[6], 2840853838, 8)),
                      i,
                      (n = rotl(n, 10)),
                      o,
                      t[15],
                ...
                (c = fn5(
                  c,
                  (s = fn5(s, h, e, _, c, t[5], 1352829926, 8)),
                  h,
                  (e = rotl(e, 10)),
                  _,
                  t[14],
                  ...
                  (h = fn5(
                    ...
                    (e = fn5(
                      e,
                      (_ = fn5(_, c, s, h, e, t[7], 1352829926, 9)),
                      c,
                      (s = rotl(s, 10)),
                      h,
                      t[0],
                  ...
                  (_ = fn5(
                    ...
                    (c = fn5(
                      c,
                      (s = fn5(s, h, e, _, c, t[2], 1352829926, 15)),
                      h,
                      (e = rotl(e, 10)),
                      _,
                      t[11],
                  ...
                  (s = fn5(
                    ...
                    (h = fn5(
                      h,
                      (e = fn5(e, _, c, s, h, t[13], 1352829926, 7)),
                      _,
                      (c = rotl(c, 10)),
                      s,
                      t[6],
                  ...
                  (e = fn5(
                    ...
                    (_ = fn5(
                      _,
                      (c = fn5(c, s, h, e, _, t[8], 1352829926, 11)),
                      s,
                      (h = rotl(h, 10)),
                      e,
                      t[1],
                  ...
                  (c = fn4(
                    ...
                    (s = fn5(
                      s,
                      (h = fn5(h, e, _, c, s, t[3], 1352829926, 12)),
                      e,
                      (_ = rotl(_, 10)),
                      c,
                      t[12],
                  ...
                  (h = fn4(
                    ...
                    (e = fn4(
                      e,
                      (_ = fn4(_, c, s, h, e, t[11], 1548603684, 13)),
                      c,
                      (s = rotl(s, 10)),
                      h,
                      t[3],
                  ...
                  (_ = fn4(
                    ...
                    (c = fn4(
                      c,
                      (s = fn4(s, h, e, _, c, t[0], 1548603684, 12)),
                      h,
                      (e = rotl(e, 10)),
                      _,
                      t[13],
                  ...
                  (s = fn4(
                    ...
                    (h = fn4(
                      h,
                      (e = fn4(e, _, c, s, h, t[10], 1548603684, 11)),
                      _,
                      (c = rotl(c, 10)),
                      s,
                      t[14],
                  ...
                  (e = fn4(
                    ...
                    (_ = fn4(
                      _,
                      (c = fn4(c, s, h, e, _, t[8], 1548603684, 12)),
                      s,
                      (h = rotl(h, 10)),
                      e,
                      t[12],
                  ...
                  (c = fn4(
                    ...
                    (s = fn4(
                      s,
                      (h = fn4(h, e, _, c, s, t[9], 1548603684, 15)),
                      e,
                      (_ = rotl(_, 10)),
                      c,
                      t[1],
                  ...
                  (h = fn3(
                    ...
                    (e = fn3(
                      e,
                      (_ = fn3(_, c, s, h, e, t[15], 1836072691, 9)),
                      c,
                      (s = rotl(s, 10)),
                      h,
                      t[5],
                  ...
                  (_ = fn3(
                    ...
                    (c = fn3(
                      c,
                      (s = fn3(s, h, e, _, c, t[3], 1836072691, 11)),
                      h,
                      (e = rotl(e, 10)),
                      _,
                      t[7],
                  ...
                  (s = fn3(
                    ...
                    (h = fn3(
                      h,
                      (e = fn3(e, _, c, s, h, t[6], 1836072691, 6)),
                      _,
                      (c = rotl(c, 10)),
                      s,
                      t[9],
                  ...
                  (e = fn3(
                    ...
                    (_ = fn3(
                      _,
                      (c = fn3(c, s, h, e, _, t[8], 1836072691, 13)),
                      s,
                      (h = rotl(h, 10)),
                      e,
                      t[12],
                  ...
                  (c = fn3(
                    ...
                    (s = fn3(
                      s,
                      (h = fn3(h, e, _, c, s, t[10], 1836072691, 13)),
                      e,
                      (_ = rotl(_, 10)),
                      c,
                      t[0],
                  ...
                  (h = fn2(
                    ...
                    (e = fn2(
                      e,
                      (_ = fn3(_, c, s, h, e, t[13], 1836072691, 5)),
                      c,
                      (s = rotl(s, 10)),
                      h,
                      t[8],
                  ...
                  (_ = fn2(
                    ...
                    (c = fn2(
                      c,
                      (s = fn2(s, h, e, _, c, t[4], 2053994217, 8)),
                      h,
                      (e = rotl(e, 10)),
                      _,
                      t[1],
                  ...
                  (s = fn2(
                    ...
                    (h = fn2(
                      h,
                      (e = fn2(e, _, c, s, h, t[11], 2053994217, 14)),
                      _,
                      (c = rotl(c, 10)),
                      s,
                      t[15],
                  ...
                  (e = fn2(
                    ...
                    (_ = fn2(
                      _,
                      (c = fn2(c, s, h, e, _, t[5], 2053994217, 6)),
                      s,
                      (h = rotl(h, 10)),
                      e,
                      t[12],
                  ...
                  (c = fn2(
                    ...
                    (s = fn2(
                      s,
                      (h = fn2(h, e, _, c, s, t[13], 2053994217, 9)),
                      e,
                      (_ = rotl(_, 10)),
                      c,
                      t[9],
                  ...
                  (h = fn1(
                    ...
                    (e = fn2(
                      e,
                      (_ = fn2(_, c, s, h, e, t[10], 2053994217, 15)),
                      c,
                      (s = rotl(s, 10)),
                      h,
                      t[14],
                  ...
                  (_ = rotl(_, 10));
                var a = (this._b + f + _) | 0;
                (this._b = (this._c + l + c) | 0),
                  (this._c = (this._d + i + s) | 0),
                  (this._d = (this._e + n + h) | 0),
                  (this._e = (this._a + o + e) | 0),
                  (this._a = a);
              }),
        ...
        { buffer: 8, "hash-base": 36, inherits: 51 },
      ],
      81: [
        function (require, module, exports) {
          (function (Buffer) {
            ...
            function _decode(e) {
              ...
              if (o <= 183) {
                if (
                  ((r = o - 127),
                  (t = 128 === o ? new Buffer([]) : e.slice(1, r)),
                  2 === r && t[0] < 128)
                )
                  throw new Error(
                    "invalid rlp encoding: byte must be less 0x80"
                  );
                return { data: t, remainder: e.slice(r) };
              }
              if (o <= 191) {
                if (
                  ((n = o - 182),
                  (r = safeParseInt(e.slice(1, n).toString("hex"), 16)),
                  (t = e.slice(n, r + n)).length < r)
                )
                  throw new Error("invalid RLP");
                return { data: t, remainder: e.slice(r + n) };
              }
              if (o <= 247) {
                for (r = o - 191, i = e.slice(1, r); i.length; )
                  (f = _decode(i)), a.push(f.data), (i = f.remainder);
                return { data: a, remainder: e.slice(r) };
              }
              var u =
                (n = o - 246) +
                (r = safeParseInt(e.slice(1, n).toString("hex"), 16));
              ...
              if (0 === (i = e.slice(n, u)).length)
                throw new Error("invalid rlp, List has a invalid length");
              for (; i.length; )
                (f = _decode(i)), a.push(f.data), (i = f.remainder);
              return { data: a, remainder: e.slice(u) };
            }
            ...
            function toBuffer(e) {
              if (!Buffer.isBuffer(e))
                if ("string" == typeof e)
                  e = isHexPrefixed(e)
                    ? new Buffer(padToEven(stripHexPrefix(e)), "hex")
                    : new Buffer(e);
                else if ("number" == typeof e)
                  e = e ? intToBuffer(e) : new Buffer([]);
                else if (null === e || void 0 === e) e = new Buffer([]);
                else {
                  if (!e.toArray) throw new Error("invalid type");
                  e = new Buffer(e.toArray());
            ...
            (exports.encode = function (e) {
              if (e instanceof Array) {
                for (var r = [], n = 0; n < e.length; n++)
                  r.push(exports.encode(e[n]));
                var t = Buffer.concat(r);
                return Buffer.concat([encodeLength(t.length, 192), t]);
              }
              return 1 === (e = toBuffer(e)).length && e[0] < 128
                ? e
                : Buffer.concat([encodeLength(e.length, 128), e]);
            }),
              (exports.decode = function (e, r) {
                ...
                return r
                  ? n
                  : (assert.equal(n.remainder.length, 0, "invalid remainder"),
                    n.data);
              }),
      ...
      82: [
        function (require, module, exports) {
          ...
          Buffer.allocUnsafeSlow
            ...
            (SafeBuffer.from = function (f, r, e) {
              if ("number" == typeof f)
        ...
        function (require, module, exports) {
          ...
          (exports.privateKeyExport = function (r, f, e) {
              ...
              if (
                ...
                if (((e += 1), !(o < 1 || o > 2 || f < e + o))) {
                  ...
                  if (
                    ...
                    return r.slice(e + 2, e + 2 + r[e + 1]);
                }
              }
            }),
            (exports.signatureExport = function (r) {
              for (
                var f = Buffer.concat([Buffer.from([0]), r.r]), e = 33, o = 0;
                e > 1 && 0 === f[o] && !(128 & f[o + 1]);
                --e, ++o
              );
              for (
                var t = Buffer.concat([Buffer.from([0]), r.s]), i = 33, n = 0;
                i > 1 && 0 === t[n] && !(128 & t[n + 1]);
                --i, ++n
              );
            ...
            (exports.signatureImport = function (r) {
              ...
              return (
                o.r.copy(f, 32 - o.r.length),
                o.s.copy(e, 32 - o.s.length),
                { r: f, s: e }
              );
            }),
                    ...
                    if (((t += n), 2 === r[t++])) {
                      ...
                      if (!(u > o - t)) {
                        ...
                        if (!(n > 32)) {
                          var a = r.slice(E, E + n);
                          for (
                            a.copy(f, 32 - a.length);
                            u > 0 && 0 === r[s];
                            u -= 1, s += 1
                          );
                          if (!(u > 32)) {
                            var c = r.slice(s, s + u);
                            return c.copy(e, 32 - c.length), { r: f, s: e };
                          }
                        }
                      }
                    }
      ...
      86: [
        function (require, module, exports) {
          ...
          function loadCompressedPublicKey(e, r) {
            ...
            var s = (n = n.toRed(ecparams.red))
              .redSqr()
              .redIMul(n)
              .redIAdd(ecparams.b)
              .redSqrt();
            return (
              (3 === e) !== s.isOdd() && (s = s.redNeg()),
              ec.keyPair({ pub: { x: n, y: s } })
            );
          }
          function loadUncompressedPublicKey(e, r, n) {
            ...
            return a.redSqr().redISub(c.redIAdd(ecparams.b)).isZero()
              ? ec.keyPair({ pub: { x: s, y: a } })
              : null;
          }
          function loadPublicKey(e) {
            ...
            switch (r) {
              ...
              case 3:
                return 33 !== e.length
                  ? null
                  : loadCompressedPublicKey(r, e.slice(1, 33));
              case 4:
              case 6:
              case 7:
                return 65 !== e.length
          ...
          (exports.privateKeyVerify = function (e) {
            ...
            (exports.privateKeyTweakAdd = function (e, r) {
              var n = new BN(r);
              if (n.cmp(ecparams.n) >= 0)
                throw new Error(messages.EC_PRIVATE_KEY_TWEAK_ADD_FAIL);
              if (
                (n.iadd(new BN(e)),
                n.cmp(ecparams.n) >= 0 && n.isub(ecparams.n),
                n.isZero())
              )
                throw new Error(messages.EC_PRIVATE_KEY_TWEAK_ADD_FAIL);
            ...
            (exports.privateKeyTweakMul = function (e, r) {
              ...
              return (
                n.imul(new BN(e)),
                n.cmp(ecparams.n) && (n = n.umod(ecparams.n)),
                n.toArrayLike(Buffer, "be", 32)
              );
            }),
            ...
            (exports.publicKeyTweakAdd = function (e, r, n) {
              ...
              if (null === s)
                throw new Error(messages.EC_PUBLIC_KEY_PARSE_FAIL);
              if ((r = new BN(r)).cmp(ecparams.n) >= 0)
            ...
            (exports.publicKeyTweakMul = function (e, r, n) {
              ...
              if (null === s)
                throw new Error(messages.EC_PUBLIC_KEY_PARSE_FAIL);
              if ((r = new BN(r)).cmp(ecparams.n) >= 0 || r.isZero())
            ...
            (exports.publicKeyCombine = function (e, r) {
              for (var n = new Array(e.length), s = 0; s < e.length; ++s)
                if (((n[s] = loadPublicKey(e[s])), null === n[s]))
                  throw new Error(messages.EC_PUBLIC_KEY_PARSE_FAIL);
              for (var a = n[0].pub, c = 1; c < n.length; ++c)
                a = a.add(n[c].pub);
              if (a.isInfinity())
            ...
            (exports.signatureNormalize = function (e) {
              ...
              if (r.cmp(ecparams.n) >= 0 || n.cmp(ecparams.n) >= 0)
                throw new Error(messages.ECDSA_SIGNATURE_PARSE_FAIL);
              var s = Buffer.from(e);
              return (
                1 === n.cmp(ec.nh) &&
                  ecparams.n.sub(n).toArrayLike(Buffer, "be", 32).copy(s, 32),
                s
              );
            }),
            ...
            (exports.sign = function (e, r, n, s) {
              if ("function" == typeof n) {
                ...
                n = function (n) {
                  ...
                  if (!Buffer.isBuffer(c) || 32 !== c.length)
                    throw new Error(messages.ECDSA_SIGN_FAIL);
                  return new BN(c);
                };
              }
              var c = new BN(r);
              if (c.cmp(ecparams.n) >= 0 || c.isZero())
                throw new Error(messages.ECDSA_SIGN_FAIL);
              var o = ec.sign(e, r, { canonical: !0, k: n, pers: s });
              return {
                signature: Buffer.concat([
                  o.r.toArrayLike(Buffer, "be", 32),
                  o.s.toArrayLike(Buffer, "be", 32),
                ]),
                recovery: o.recoveryParam,
              };
            }),
            (exports.verify = function (e, r, n) {
              var s = { r: r.slice(0, 32), s: r.slice(32, 64) },
                a = new BN(s.r),
                c = new BN(s.s);
              if (a.cmp(ecparams.n) >= 0 || c.cmp(ecparams.n) >= 0)
                throw new Error(messages.ECDSA_SIGNATURE_PARSE_FAIL);
              if (1 === c.cmp(ec.nh) || a.isZero() || c.isZero()) return !1;
              var o = loadPublicKey(n);
              if (null === o)
                throw new Error(messages.EC_PUBLIC_KEY_PARSE_FAIL);
              return ec.verify(e, s, { x: o.pub.x, y: o.pub.y });
            }),
            (exports.recover = function (e, r, n, s) {
              var a = { r: r.slice(0, 32), s: r.slice(32, 64) },
                c = new BN(a.r),
                o = new BN(a.s);
            ...
            (exports.ecdhUnsafe = function (e, r, n) {
              ...
              if (null === s)
                throw new Error(messages.EC_PUBLIC_KEY_PARSE_FAIL);
              var a = new BN(r);
              if (a.cmp(ecparams.n) >= 0 || a.isZero())
      ...
      87: [
        function (require, module, exports) {
          ...
          function initCompressedValue(e, s) {
            return void 0 === e
              ? s
              : (assert.isBoolean(e, messages.COMPRESSED_TYPE_INVALID), e);
          }
          ...
          module.exports = function (e) {
            return {
              privateKeyVerify: function (s) {
                return (
                  assert.isBuffer(s, messages.EC_PRIVATE_KEY_TYPE_INVALID),
                  32 === s.length && e.privateKeyVerify(s)
                );
              },
              ...
              privateKeyImport: function (s) {
                if (
                  (assert.isBuffer(s, messages.EC_PRIVATE_KEY_TYPE_INVALID),
                  (s = der.privateKeyImport(s)) &&
                    32 === s.length &&
                    e.privateKeyVerify(s))
                )
                  return s;
              ...
              privateKeyTweakAdd: function (s, r) {
                return (
                  ...
                  assert.isBufferLength(r, 32, messages.TWEAK_LENGTH_INVALID),
                  e.privateKeyTweakAdd(s, r)
                );
              },
              ...
              publicKeyCreate: function (s, r) {
                return (
                  ...
                  (r = initCompressedValue(r, !0)),
                  e.publicKeyCreate(s, r)
                );
              },
              publicKeyConvert: function (s, r) {
                return (
                  assert.isBuffer(s, messages.EC_PUBLIC_KEY_TYPE_INVALID),
              ...
              publicKeyTweakAdd: function (s, r, _) {
                return (
                  ...
                  assert.isBuffer(r, messages.TWEAK_TYPE_INVALID),
                  assert.isBufferLength(r, 32, messages.TWEAK_LENGTH_INVALID),
                  (_ = initCompressedValue(_, !0)),
                  e.publicKeyTweakAdd(s, r, _)
                );
              },
              publicKeyTweakMul: function (s, r, _) {
                return (
                  ...
                  assert.isBufferLength(r, 32, messages.TWEAK_LENGTH_INVALID),
                  (_ = initCompressedValue(_, !0)),
                  e.publicKeyTweakMul(s, r, _)
                );
              },
              publicKeyCombine: function (s, r) {
                assert.isArray(s, messages.EC_PUBLIC_KEYS_TYPE_INVALID),
                  assert.isLengthGTZero(
                    s,
                    messages.EC_PUBLIC_KEYS_LENGTH_INVALID
                  );
                for (var _ = 0; _ < s.length; ++_)
                  assert.isBuffer(s[_], messages.EC_PUBLIC_KEY_TYPE_INVALID),
                    assert.isBufferLength2(
                      s[_],
                      33,
                      65,
                ...
                return (
                  (r = initCompressedValue(r, !0)), e.publicKeyCombine(s, r)
                );
              },
              signatureNormalize: function (s) {
                return (
                  assert.isBuffer(s, messages.ECDSA_SIGNATURE_TYPE_INVALID),
                  assert.isBufferLength(
                    s,
                    64,
                    messages.ECDSA_SIGNATURE_LENGTH_INVALID
                  ),
                  e.signatureNormalize(s)
                );
              },
              ...
              sign: function (s, r, _) {
                assert.isBuffer(s, messages.MSG32_TYPE_INVALID),
                  assert.isBufferLength(s, 32, messages.MSG32_LENGTH_INVALID),
                  assert.isBuffer(r, messages.EC_PRIVATE_KEY_TYPE_INVALID),
                  assert.isBufferLength(
                    r,
                    32,
                    messages.EC_PRIVATE_KEY_LENGTH_INVALID
                ...
                return (
                  void 0 !== _ &&
                    (assert.isObject(_, messages.OPTIONS_TYPE_INVALID),
                    void 0 !== _.data &&
                      (assert.isBuffer(
                        _.data,
              ...
              verify: function (s, r, _) {
                return (
                  assert.isBuffer(s, messages.MSG32_TYPE_INVALID),
                  assert.isBufferLength(s, 32, messages.MSG32_LENGTH_INVALID),
                  assert.isBuffer(r, messages.ECDSA_SIGNATURE_TYPE_INVALID),
                  assert.isBufferLength(
                    r,
                    64,
                    messages.ECDSA_SIGNATURE_LENGTH_INVALID
                  ),
                  assert.isBuffer(_, messages.EC_PUBLIC_KEY_TYPE_INVALID),
                  assert.isBufferLength2(
                    _,
                    33,
                    65,
              ...
              recover: function (s, r, _, E) {
                return (
                  ...
                  assert.isNumber(_, messages.RECOVERY_ID_TYPE_INVALID),
        ...
        { "./assert": 84, "./der": 85, "./messages.json": 88 },
      ],
      88: [
        function (require, module, exports) {
          module.exports = {
        ...
        function (require, module, exports) {
          ...
          (Hash.prototype.update = function (t, i) {
            ...
            for (
              ...
              for (var r = o % s, _ = Math.min(h - l, s - r), n = 0; n < _; n++)
                e[r + n] = t[l + n];
            ...
            (Hash.prototype.digest = function (t) {
              ...
              if (e <= 4294967295)
                ...
                var s = 4294967295 & e,
                  h = (e - s) / 4294967296;
                this._block.writeUInt32BE(h, this._blockSize - 8),
      ...
      91: [
          ...
          inherits(Sha, Hash),
            ...
            (Sha.prototype._update = function (t) {
              for (
                ...
                i[_] = t.readInt32BE(4 * _);
              for (; _ < 80; ++_)
                i[_] = i[_ - 3] ^ i[_ - 8] ^ i[_ - 14] ^ i[_ - 16];
              for (var a = 0; a < 80; ++a) {
                var o = ~~(a / 20),
        ...
        { "./hash": 89, inherits: 51, "safe-buffer": 82 },
      ],
      92: [
        function (require, module, exports) {
          function Sha1() {
          ...
          inherits(Sha1, Hash),
            ...
            (Sha1.prototype._update = function (t) {
              for (
                ...
                i[_] = t.readInt32BE(4 * _);
              for (; _ < 80; ++_)
                i[_] = rotl1(i[_ - 3] ^ i[_ - 8] ^ i[_ - 14] ^ i[_ - 16]);
              for (var a = 0; a < 80; ++a) {
                var o = ~~(a / 20),
                  f = (rotl5(r) + ft(o, h, s, e) + n + i[a] + K[o]) | 0;
                (n = e), (e = s), (s = rotl30(h)), (h = r), (r = f);
      ...
      93: [
        ...
        { "./hash": 89, "./sha256": 94, inherits: 51, "safe-buffer": 82 },
      ],
      94: [
        function (require, module, exports) {
          function Sha256() {
      ...
      95: [
        ...
        { "./hash": 89, "./sha512": 96, inherits: 51, "safe-buffer": 82 },
      ],
      96: [
        function (require, module, exports) {
          function Sha512() {
          ...
          inherits(Sha512, Hash),
            ...
            (Sha512.prototype._update = function (h) {
              for (
                ...
                (t[d] = h.readInt32BE(4 * d)),
                  (t[d + 1] = h.readInt32BE(4 * d + 4));
              for (; d < 160; d += 2) {
                var b = t[d - 30],
                  p = t[d - 30 + 1],
                  G = Gamma0(b, p),
              ...
              (this._al = (this._al + f) | 0),
                ...
                (this._ah = (this._ah + i + getCarry(this._al, f)) | 0),
                (this._bh = (this._bh + s + getCarry(this._bl, g)) | 0),
                (this._ch = (this._ch + r + getCarry(this._cl, u)) | 0),
                (this._dh = (this._dh + _ + getCarry(this._dl, c)) | 0),
                (this._eh = (this._eh + a + getCarry(this._el, m)) | 0),
                (this._fh = (this._fh + e + getCarry(this._fl, o)) | 0),
                (this._gh = (this._gh + l + getCarry(this._gl, y)) | 0),
                (this._hh = (this._hh + n + getCarry(this._hl, C)) | 0);
            }),
      ...
      98: [
        function (require, module, exports) {
          ...
          function normalizeEncoding(t) {
            ...
            if (
              "string" != typeof e &&
              (Buffer.isEncoding === isEncoding || !isEncoding(t))
            )
          ...
          function utf8CheckExtraBytes(t, e, s) {
            ...
            if (t.lastNeed > 1 && e.length > 1) {
              if (128 != (192 & e[1]))
                return (t.lastNeed = 1), "�".repeat(s + 1);
              if (t.lastNeed > 2 && e.length > 2 && 128 != (192 & e[2]))
                return (t.lastNeed = 2), "�".repeat(s + 2);
            }
          }
      ...
      103: [
                ...
                u ||
                  (e.seen.indexOf(c.value) < 0
                    ? (u = isNull(t)
                        ...
                        : formatValue(e, c.value, t - 1)).indexOf("\n") > -1 &&
                      (u = o
                        ? u
                            .split("\n")
                            .map(function (e) {
        ...
        { "./support/isBuffer": 102, _process: 66, inherits: 101 },
      ],
      104: [
        function (require, module, exports) {
          "use strict";
        ...
        { buffer: 8, "ethereumjs-tx": 31, "ethereumjs-util": 33 },
      ],
    },
    {},
    [104]
